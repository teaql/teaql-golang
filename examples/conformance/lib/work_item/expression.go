...
func (e *WorkItemExpression) Title() *ValueExpression[string] {
	...
	if !e.value.IsLoaded("title") {
		return notLoadedExpression[string](e.fieldError("title"))
	}
...
func (e *WorkItemExpression) Description() *ValueExpression[*string] {
	...
	if !e.value.IsLoaded("description") {
		return notLoadedExpression[*string](e.fieldError("description"))
	}
