...
type CustomerCheckerLogic interface {
	CheckAndFix(ctx *runtime.UserContext, entity *Customer, status any, location any, results any)
...
func (c *NoopCustomerChecker) CheckAndFix(ctx *runtime.UserContext, entity *Customer, status any, location any, results any) {}
...
func (c *CustomerChecker) CheckAndFixTyped(ctx *runtime.UserContext, entity *Customer, status any, location any, results any) {
	if c.logic != nil {
