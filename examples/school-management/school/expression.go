...
func (e *SchoolExpression) Address() *ValueExpression[string] {
	...
	if !e.value.IsLoaded("address") {
		return notLoadedExpression[string](e.fieldError("address"))
	}
...
func (e *SchoolExpression) EstablishedDate() *ValueExpression[time.Time] {
	if e.err != nil {
		return notLoadedExpression[time.Time](e.err)
	}
	if e.value == nil {
		return missingExpression[time.Time]()
	}
	if !e.value.IsLoaded("established_date") {
		return notLoadedExpression[time.Time](e.fieldError("established_date"))
	}
...
func (e *SchoolExpression) StudentCapacity() *ValueExpression[int64] {
	...
	if !e.value.IsLoaded("student_capacity") {
		return notLoadedExpression[int64](e.fieldError("student_capacity"))
	}
...
func (e *SchoolExpression) Active() *ValueExpression[bool] {
	if e.err != nil {
		return notLoadedExpression[bool](e.err)
	}
	if e.value == nil {
		return missingExpression[bool]()
	}
	if !e.value.IsLoaded("active") {
		return notLoadedExpression[bool](e.fieldError("active"))
	}
...
func (e *SchoolExpression) CreateTime() *ValueExpression[time.Time] {
	...
	if !e.value.IsLoaded("create_time") {
		return notLoadedExpression[time.Time](e.fieldError("create_time"))
	}
...
func (e *SchoolExpression) UpdateTime() *ValueExpression[time.Time] {
	...
	if !e.value.IsLoaded("update_time") {
		return notLoadedExpression[time.Time](e.fieldError("update_time"))
	}
...
func (e *PlatformRelationExpression) Id() *ValueExpression[uint64] {
	...
	raw, ok := e.value["id"]
	if !ok {
		return notLoadedExpression[uint64](&TeaQLNotLoadedError{Root: e.root, AccessPath: e.path + ".id", BreakPoint: "id"})
	}
	if raw.IsNull() {
		return missingExpression[uint64]()
	}
	value, valid := raw.TryU64()
	if !valid {
		return missingExpression[uint64]()
	}
...
func (e *PlatformRelationExpression) Name() *ValueExpression[string] {
	...
	raw, ok := e.value["name"]
	if !ok {
		return notLoadedExpression[string](&TeaQLNotLoadedError{Root: e.root, AccessPath: e.path + ".name", BreakPoint: "name"})
	}
	if raw.IsNull() {
		return missingExpression[string]()
	}
	value, valid := raw.TryText()
	if !valid {
		return missingExpression[string]()
	}
	return valueExpression(value)
...
func (e *PlatformRelationExpression) BaseUrl() *ValueExpression[string] {
	...
	if !ok {
		return notLoadedExpression[string](&TeaQLNotLoadedError{Root: e.root, AccessPath: e.path + ".base_url", BreakPoint: "base_url"})
	}
	if raw.IsNull() {
		return missingExpression[string]()
	}
...
func (e *PlatformRelationExpression) CreateTime() *ValueExpression[time.Time] {
	...
	if !ok {
		return notLoadedExpression[time.Time](&TeaQLNotLoadedError{Root: e.root, AccessPath: e.path + ".create_time", BreakPoint: "create_time"})
	}
	if raw.IsNull() {
		return missingExpression[time.Time]()
	}
	value, valid := raw.TryTime()
	if !valid {
		return missingExpression[time.Time]()
	}
	return valueExpression(value)
...
func (e *PlatformRelationExpression) UpdateTime() *ValueExpression[time.Time] {
	...
	if !ok {
		return notLoadedExpression[time.Time](&TeaQLNotLoadedError{Root: e.root, AccessPath: e.path + ".update_time", BreakPoint: "update_time"})
	}
	if raw.IsNull() {
		return missingExpression[time.Time]()
	}
...
func (e *PlatformRelationExpression) Version() *ValueExpression[int64] {
	...
	if !ok {
		return notLoadedExpression[int64](&TeaQLNotLoadedError{Root: e.root, AccessPath: e.path + ".version", BreakPoint: "version"})
	}
	if raw.IsNull() {
		return missingExpression[int64]()
	}
	value, valid := raw.TryI64()
	if !valid {
		return missingExpression[int64]()
	}
	return valueExpression(value)
...
func (e *SchoolExpression) PlatformId() *ValueExpression[uint64] {
	...
	if !e.value.IsLoaded("platform_id") {
		return notLoadedExpression[uint64](e.fieldError("platform_id"))
	}
	...
	if values, list := raw.TryList(); list && len(values) != 0 {
		if record, object := values[0].TryObject(); object {
			if id, found := record["id"]; found {
				if value, valid := id.TryU64(); valid {
					return valueExpression(value)
				}
			}
		}
...
func (e *SchoolExpression) Platform() *PlatformRelationExpression {
	...
	if e.err != nil {
		return &PlatformRelationExpression{root: e.root, path: path, err: e.err}
	}
	if e.value == nil {
...
func (e *SchoolTypeRelationExpression) Code() *ValueExpression[string] {
	...
	raw, ok := e.value["code"]
	if !ok {
		return notLoadedExpression[string](&TeaQLNotLoadedError{Root: e.root, AccessPath: e.path + ".code", BreakPoint: "code"})
	}
	if raw.IsNull() {
		return missingExpression[string]()
	}
...
func (e *SchoolTypeRelationExpression) DisplayOrder() *ValueExpression[decimal.Decimal] {
	if e.err != nil {
		return notLoadedExpression[decimal.Decimal](e.err)
	}
	if e.value == nil {
		return missingExpression[decimal.Decimal]()
	}
	raw, ok := e.value["display_order"]
	if !ok {
		return notLoadedExpression[decimal.Decimal](&TeaQLNotLoadedError{Root: e.root, AccessPath: e.path + ".display_order", BreakPoint: "display_order"})
	}
	if raw.IsNull() {
		return missingExpression[decimal.Decimal]()
	}
	value, valid := raw.TryDecimal()
	if !valid {
		return missingExpression[decimal.Decimal]()
	}
	return valueExpression(value)
...
func (e *SchoolExpression) SchoolTypeId() *ValueExpression[uint64] {
	...
	if !e.value.IsLoaded("school_type_id") {
		return notLoadedExpression[uint64](e.fieldError("school_type_id"))
	}
...
func (e *SchoolExpression) SchoolType() *SchoolTypeRelationExpression {
	...
	if e.err != nil {
		return &SchoolTypeRelationExpression{root: e.root, path: path, err: e.err}
	}
	if e.value == nil {
