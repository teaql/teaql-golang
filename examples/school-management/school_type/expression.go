...
func (e *SchoolTypeExpression) Code() *ValueExpression[string] {
	...
	if !e.value.IsLoaded("code") {
		return notLoadedExpression[string](e.fieldError("code"))
	}
...
func (e *SchoolTypeExpression) DisplayOrder() *ValueExpression[decimal.Decimal] {
	...
	if !e.value.IsLoaded("display_order") {
		return notLoadedExpression[decimal.Decimal](e.fieldError("display_order"))
	}
...
func (e *SchoolListExpression) First() *school.SchoolExpression {
	...
	if e.value == nil || len(e.value.Items()) == 0 {
		return school.NewSchoolExpression(nil)
	}
...
func (e *SchoolTypeExpression) SchoolList() *SchoolListExpression {
	if e.err != nil {
		return &SchoolListExpression{err: e.err}
	}
	if e.value == nil {
		return &SchoolListExpression{}
	}
	if !e.value.IsLoaded("schoolList") {
		return &SchoolListExpression{err: e.fieldError("schoolList"), root: e.root, path: "schoolList"}
	}
