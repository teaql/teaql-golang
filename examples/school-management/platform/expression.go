...
func (e *PlatformExpression) BaseUrl() *ValueExpression[string] {
	...
	if !e.value.IsLoaded("base_url") {
		return notLoadedExpression[string](e.fieldError("base_url"))
	}
...
func (e *SchoolTypeListExpression) First() *school_type.SchoolTypeExpression {
	...
	if e.value == nil || len(e.value.Items()) == 0 {
		return school_type.NewSchoolTypeExpression(nil)
	}
...
func (e *PlatformExpression) SchoolTypeList() *SchoolTypeListExpression {
	if e.err != nil {
		return &SchoolTypeListExpression{err: e.err}
	}
	if e.value == nil {
		return &SchoolTypeListExpression{}
	}
	if !e.value.IsLoaded("schoolTypeList") {
		return &SchoolTypeListExpression{err: e.fieldError("schoolTypeList"), root: e.root, path: "schoolTypeList"}
	}
