...
type TaskExecutionLogCheckerLogic interface {
	CheckAndFix(ctx *runtime.UserContext, entity *TaskExecutionLog, status any, location any, results any)
...
func (c *NoopTaskExecutionLogChecker) CheckAndFix(ctx *runtime.UserContext, entity *TaskExecutionLog, status any, location any, results any) {}
...
func (c *TaskExecutionLogChecker) CheckAndFixTyped(ctx *runtime.UserContext, entity *TaskExecutionLog, status any, location any, results any) {
	if c.logic != nil {
