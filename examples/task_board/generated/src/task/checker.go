...
type TaskCheckerLogic interface {
	CheckAndFix(ctx *runtime.UserContext, entity *Task, status any, location any, results any)
...
func (c *NoopTaskChecker) CheckAndFix(ctx *runtime.UserContext, entity *Task, status any, location any, results any) {}
...
func (c *TaskChecker) CheckAndFixTyped(ctx *runtime.UserContext, entity *Task, status any, location any, results any) {
	if c.logic != nil {
